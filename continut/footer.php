			...
			<form class='form' action='' method='POST'>
				<div class="modal-body">
					...
					<div class="input-group mt-4">
						...
						<input type="text" class="form-control" placeholder="E-mail" autocomplete="off" reuqired>
					</div>
					<div class="input-group mt-4 mb-4">
						<span class="input-group-text">Parola</span>
						<input type="password" class="form-control" placeholder="Parola" autocomplete="off" reuqired>
					</div>
